...
import browse.by.voice.materialnavigationdrawer.activity.MaterialNavImageActivity;
...
public class ImageHeaderActivity extends MaterialNavImageActivity {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        menu.add(new MaterialItemSectionFragment(this, "Instruction", fragmentInstruction, "Image Header"));
