 ...
 */
public class HeadItemOneBelowToolbarActivity extends MaterialNavHeadItemActivity {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        bundle.putString("instruction", "This example shows the head item style. The drawer" +
                " is shown below the toolbar.");
