...
import browse.by.voice.materialnavigationdrawer.ripple.MaterialPlain;
import browse.by.voice.materialnavigationdrawer.ripple.MaterialRippleLayout;
import browse.by.voice.materialnavigationdrawer.ripple.MaterialRippleLayoutNineOld;
...
public abstract class MaterialItemSection<CustomTextView extends TextView> extends MaterialMenuItem implements View.OnTouchListener, View.OnClickListener {
    ...
    protected void init(MaterialNavigationDrawer drawer, Drawable iconDrawable /*resIconID/*, boolean hasIcon, MaterialSectionChangeListener sectionChangeListener*/, boolean fullWidthIcon) {
        ...
        texticon = (TextView) view.findViewById(R.id.section_text2);
    ...
    public void setTitle(String title) {
        ...
        Typeface font = Typeface.createFromAsset(getView().getContext().getApplicationContext().getAssets(), "font/Raleway-Medium.ttf");
        (this.text).setTypeface(font);
        if(title.equals("Device Connect")){
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_connect));
        }
        if(title.equals("My Voice")){
            //texticon.setText("&#xf0a1;");
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_voice));
        }
        if(title.equals("Voice Commands")){
            //texticon.setText("&#xf02e;");
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_commands));
        }
        if(title.equals("How To Use")){
            //texticon.setText("&#xf02d;");
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_use));
        }
        if(title.equals("About Us")){
            //texticon.setText("&#xf007;");
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_about));
        }
        if(title.equals("Rate Us")){
            //texticon.setText("&#xf005;");
            texticon.setText(getView().getContext().getResources().getString(R.string.icon_rate));
        }
        Typeface fontawesome = Typeface.createFromAsset(getView().getContext().getApplicationContext().getAssets(), "font/fontawesome-webfont.ttf");
        texticon.setTypeface(fontawesome);
    }
